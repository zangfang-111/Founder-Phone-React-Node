...
function attributeMatched(attribute, line, contact) {
  switch (attribute) {
    ...
    case "EMAIL;":
      var email_obj = {};
      email_obj.value = s(line.substring(line.indexOf(":") + 1))
        .clean()
        .value();
    ...
    case "TEL;":
      var phone_obj = {};
      phone_obj.value = s(line.substring(line.indexOf(":") + 1))
        .clean()
        .value();
    ...
    case "ORG:":
      console.log(line);
      contact.org = s(line.slice(10)).clean().value();
      break;
  }
}
